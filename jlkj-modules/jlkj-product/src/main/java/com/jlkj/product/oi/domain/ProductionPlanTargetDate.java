 ...
 * @author  generator
 * 计划管理--日指标计划
 * @TableName product_oi_plan_target_date
 */
@TableName(value ="product_oi_plan_target_date")
@Data
public class ProductionPlanTargetDate implements Serializable {
    /**
     * 计划编号;UUID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        ProductionPlanTargetDate other = (ProductionPlanTargetDate) that;
