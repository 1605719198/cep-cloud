 ...
 * @author  generator
 * 计划管理--月产量计划表
 * @TableName product_oi_plan_output_month
 */
@TableName(value ="product_oi_plan_output_month")
@Data
public class ProductionPlanOutputMonth implements Serializable {
    /**
     * 计划编号;UUID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        ProductionPlanOutputMonth other = (ProductionPlanOutputMonth) that;
