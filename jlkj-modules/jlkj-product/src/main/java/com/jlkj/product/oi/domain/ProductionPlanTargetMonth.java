 ...
 * @author  generator
 * 计划管理-月指标计划
 * @TableName product_oi_plan_target_month
 */
@TableName(value ="product_oi_plan_target_month")
@Data
public class ProductionPlanTargetMonth implements Serializable {
    /**
     * 计划编号;UUID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        ProductionPlanTargetMonth other = (ProductionPlanTargetMonth) that;
