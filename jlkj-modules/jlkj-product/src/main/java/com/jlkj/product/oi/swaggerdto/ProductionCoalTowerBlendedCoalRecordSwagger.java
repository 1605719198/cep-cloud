...
/**
 * @author zyf
 * @TableName 生产实绩-储煤塔配煤记录
 * @TableName product_oi_coal_tower_blended_coal_record
 */
@Data
public class ProductionCoalTowerBlendedCoalRecordSwagger implements Serializable {
    ...
    @Schema(title = "配煤计划id")
    private String coal_blending_plan_id;

    @Schema(title = "配煤计划编号")
    private String coal_blending_plan_number;
    ...
    @Schema(title = "配煤前重量")
    private String coal_weight_befor;

    @Schema(title = "配煤后重量")
    private String coal_weight_after;

    @Schema(title = "配煤前料位")
    private String coal_material_level_befor;

    @Schema(title = "配煤后料位")
    private String coal_material_level_after;
