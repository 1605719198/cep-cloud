...
public class ProductionConveyingCoalRecordController {
    ...
    /**
     * 生产实绩-上煤记录-新增
     * @param insertProductionConveyingCoalRecordDTO
     */
    ...
    public void insertProductionConveyingCoalRecordData(@Valid @RequestBody InsertProductionConveyingCoalRecordDTO insertProductionConveyingCoalRecordDTO) {
        ...
        productionConveyingCoalRecordService.insertProductionConveyingCoalRecordData(insertProductionConveyingCoalRecordDTO);
    }

    /**
     * 生产实绩-上煤记录-删除
     * @param deleteProductionConveyingCoalRecordDTO
     */
    ...
    public void deleteProductionConveyingCoalRecordData(@Valid @RequestBody DeleteProductionConveyingCoalRecordDTO deleteProductionConveyingCoalRecordDTO) {
        ...
        productionConveyingCoalRecordService.deleteProductionConveyingCoalRecordData(deleteProductionConveyingCoalRecordDTO);
    }

    /**
     * 生产实绩-上煤记录-查询-分页
     * @param pageProductionConveyingCoalRecordDTO
     * @return
     */
    ...
    public AjaxResult getProductionConveyingCoalRecordPageData(@Validated @ParamModel PageProductionConveyingCoalRecordDTO pageProductionConveyingCoalRecordDTO) {
