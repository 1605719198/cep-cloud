package com.jlkj.material.mr.dto.materialscokestockhistory;
 ...
 */
@Data
public class PageMaterialsCokeStockHistoryDTO {
	...
	@NotNull(message = "焦场库存id必须项")
	@NotEmpty(message = "焦场库存id不能为空")
	private String id;
}
