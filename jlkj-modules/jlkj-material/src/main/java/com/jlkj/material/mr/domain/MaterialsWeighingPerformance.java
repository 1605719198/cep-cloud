...
/**
 * 原料检斤实绩表
 * @TableName materials_mr_weighing_performance
 * @author zyf
 */
@TableName(value ="materials_mr_weighing_performance")
@Data
public class MaterialsWeighingPerformance implements Serializable {
    /**
     * 主键标识;UUID
     */
    @TableId
