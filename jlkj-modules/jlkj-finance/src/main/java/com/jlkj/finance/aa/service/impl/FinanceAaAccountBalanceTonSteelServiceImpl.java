...
public class FinanceAaAccountBalanceTonSteelServiceImpl implements IFinanceAaAccountBalanceTonSteelService {
     ...
     */
    @Override
    public List<FinanceAaLedgerAcctDTO> reportListDetailIfSteel(FinanceAaLedgerAcctDTO financeAaLedgerAcctDTO) {
        ...
        //合并层级
        if (financeAaLedgerAcctDTOS.size()>0){
            financeAaLedgerAcctDTOS1 = reportAccountLevel(financeAaLedgerAcctDTOS, financeAaLedgerAcctDTO);
        }
        return financeAaLedgerAcctDTOS1;
    }
    ...
    public  List<FinanceAaLedgerAcctDTO>  reportAccountLevel(List<FinanceAaLedgerAcctDTO> financeAaLedgerAcctDTO,FinanceAaLedgerAcctDTO financeAaLedgerAcctDTO2){
        List<FinanceAaLedgerAcctDTO> financeAaLedgerAcctList = new ArrayList<>();
