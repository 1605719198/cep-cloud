 ...
 */
@Service
public class FinanceAaCashflowCodeTreeServiceImpl  extends ServiceImpl<FinanceAaCashflowCodeTreeMapper, FinanceAaCashflowCode>
        implements IFinanceAaCashflowCodeTreeService {
    /**
     * 选单配置树结构列表
     * @return
     */
    @Override
    public List<FinanceAaCashflowCodeDTO> getBaseInfoTreeList() {
