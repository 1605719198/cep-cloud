...
public class FinanceCostController {
     ...
     */
    @Log(title = "根据成本中心编码、成本中心名称、年度查询", businessType = BusinessType.OTHER)
     ...
     * 成本中心设定接口
     */
    @Log(title = "成本中心设定接口", businessType = BusinessType.OTHER)
     ...
     * 属性弹窗查询
     */
    @Log(title = "属性弹窗查询", businessType = BusinessType.OTHER)
     ...
     *
     */
    @Log(title = "修改成本中心", businessType = BusinessType.UPDATE)
     ...
     *
     */
    @Log(title = "删除成本中心资料", businessType = BusinessType.DELETE)
    ...
    @Log(title = "删除属性资料", businessType = BusinessType.DELETE)
