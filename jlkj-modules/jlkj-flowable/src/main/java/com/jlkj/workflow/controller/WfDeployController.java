...
import com.jlkj.workflow.service.IWfDeployService;
...
public class WfDeployController extends BaseController {
    ...
    @GetMapping("/list")
    public TableDataInfoPlus<WfDeployVo> list(ProcessQuery processQuery, PageQuery pageQuery) {
    ...
    public TableDataInfoPlus<WfDeployVo> publishList(@RequestParam String processKey, PageQuery pageQuery) {
