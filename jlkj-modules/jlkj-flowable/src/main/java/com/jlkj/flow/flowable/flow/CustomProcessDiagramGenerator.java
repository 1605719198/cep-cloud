package com.jlkj.flow.flowable.flow;
...
public class CustomProcessDiagramGenerator extends DefaultProcessDiagramGenerator {
    ...
    protected static DefaultProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType, String activityFontName, String labelFontName, String annotationFontName, ClassLoader customClassLoader) {
        ...
        return new com.jlkj.flow.flowable.flow.CustomProcessDiagramCanvas((int) maxX + 10, (int) maxY + 10, (int) minX, (int) minY, imageType, activityFontName, labelFontName, annotationFontName, customClassLoader);
    }
    ...
    private static void drawHighLightNow(com.jlkj.flow.flowable.flow.CustomProcessDiagramCanvas processDiagramCanvas, GraphicInfo graphicInfo) {
    ...
    private static void drawHighLightEnd(com.jlkj.flow.flowable.flow.CustomProcessDiagramCanvas processDiagramCanvas, GraphicInfo graphicInfo) {
