...
export const getPageProductionRealOutputMonth = (page, query) => {
  return request({
    url: '/api/neplatform/production/real/getPageProductionRealOutputMonth',
    method: 'get',
    params: {
      ...page,
      ...query,
...
export const getPageProductionRealOutputDate = (page, query) => {
  return request({
    url: '/api/neplatform/production/real/getPageProductionRealOutputDate',
    method: 'get',
    params: {
      ...page,
      ...query,
...
export const getProductionRealOutputMonthTargetItemChart = (params) => {
  return request({
    url: '/api/neplatform/production/real/getProductionRealOutputMonthTargetItemChart',
    method: 'get',
    params
  })
};
...
export const getProductionRealOutputDateTargetItemChart = (params) => {
  return request({
    url: '/api/neplatform/production/real/getProductionRealOutputDateTargetItemChart',
    method: 'get',
    params
  })
};
...
export const getProductionPlanOutputMonthTargetItemChart = (params) => {
  return request({
    url: '/api/neplatform/production/plan/getProductionPlanOutputMonthTargetItemChart',
    method: 'get',
    params
  })
};
...
export const getProductionPlanOutputDateTargetItemChart = (params) => {
  return request({
    url: '/api/neplatform/production/plan/getProductionPlanOutputDateTargetItemChart',
    method: 'get',
    params
  })
};
...
export const getProductionRealOutputMonthRangeChart = (params) => {
  return request({
    url: '/api/neplatform/production/real/getProductionRealOutputMonthRangeChart',
    method: 'get',
    params
  })
};
