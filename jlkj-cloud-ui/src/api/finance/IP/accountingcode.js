...
export function listFinancetest(data) {
  return request({
    url: '/api/neplatform/fin/finance/product/accountItemCode/queryAll',
    method: 'get',
    params: data
  })
}
...
export function getFinanceInformation(data) {
  return request({
    url: '/api/neplatform/fin/finance/product/accountItemCode/queryAccount' ,
    method: 'get',
    params: data
  })
}
...
export function getFinanceMcc(compIdMcc,leafIdMcc) {
  return request({
    url: '/api/neplatform/fin/finance/product/accountItemCode/queryAccountMcc' ,
    method: 'get',
    params:{
      compIdMcc: compIdMcc,
      leafIdMcc:leafIdMcc
...
export function attributeQueryOne(attriName) {
  return request({
    url: `/api/neplatform/fin/finance/product/accountItemCode/attributeQueryOne?attriName=${attriName}`,
    method: 'get'
  })
}
...
export function getFinancetest(accountItemCode,id) {
  return request({
    url: '/api/neplatform/fin/finance/product/accountItemCode/queryOne' ,
    method: 'get',
    params:{
...
export function addFinancetest(data) {
  return request({
    url: '/api/neplatform/fin/finance/product/accountItemCode/doAdd',
    method: 'post',
    data: data
  })
}
...
export function addFinanceattri(data) {
  return request({
    url: `/api/neplatform/fin/finance/product/accountItemCode/attriAdd`,
    method: 'post',
    data: data
  })
}
...
export function updateFinancetest(data) {
  return request({
    url: '/api/neplatform/fin/finance/product/accountItemCode/doEdit',
    method: 'post',
    data: data
  })
}
...
export function updateFinanceattri(data) {
  return request({
    url: '/api/neplatform/fin/finance/product/accountItemCode/doEditAttri',
    method: 'post',
    data: data
  })
}
...
export function delFinancetest(id) {
  return request({
    url: `/api/neplatform/fin/finance/product/accountItemCode/delete?id=${id}` ,
    method: 'delete'
  })
