...
import {
    productionReportExcipientConsumeList,
    productionReportExcipientConsumeDelete,
...
export default {
    ...
    methods: {
        //获取辅料名称下拉列表
        getIngredientsName() {
            getDicts('report_excipient_name').then((response) => {
                this.nameOptions = response.data.data.map((i) => {
        ...
        onLoad() {
            ...
            productionReportExcipientConsumeList(this.page, this.query).then(
                (res) => {
