<template>
        ...
        <div>
            <el-table height="73vh"
                ...
                <el-table-column label="车型"
                                 ...
                                 align="left"
                                 prop="dict_label" />
                <el-table-column label="吨数(t)"
                                 sortable
                                 minWidth="150"
                                 align="left"
                                 prop="tonnes" />
                <el-table-column label="用车时长(h)"
                                 sortable
                                 minWidth="150"
                                 align="left"
                                 prop="car_time" />
                <el-table-column label="当日费用(元)"
                                 sortable
                                 minWidth="150"
                                 align="left"
                                 prop="day_cost" />
  ...
  <script>
import {
    productionReportLiftingCostsList,
    productionReportLiftingCostsDelete,
...
export default {
    ...
    methods: {
        ...
        onLoad() {
            ...
            productionReportLiftingCostsList(this.page, this.query).then(
                (res) => {
