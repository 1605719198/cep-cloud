<template>
    <div class="avue-crud el-card__body"
        ...
        <div>
            <el-table height="73vh"
                ...
                <el-table-column label="卸车费(元)"
                                 sortable
                                 minWidth="150"
                                 align="left"
                                 prop="unloading_fee" />
                <el-table-column label="倒运费(元)"
                                 sortable
                                 minWidth="150"
                                 align="left"
                                 prop="reverse_fee" />
                <el-table-column label="临时用(元)"
                                 sortable
                                 minWidth="150"
                                 align="left"
                                 prop="temporary_fee" />
  ...
  <script>
import {
    productionReportLogisticsCostsList,
    productionReportLogisticsCostsDelete,
...
export default {
    ...
    methods: {
        ...
        onLoad() {
            ...
            productionReportLogisticsCostsList(this.page, this.query).then(
                (res) => {
        ...
        totalFormatter(row) {
            return (
                (row.unloading_fee * 1000000 +
                    row.reverse_fee * 1000000 +
                    row.temporary_fee * 1000000) /
                1000000
            )
        },
    },
