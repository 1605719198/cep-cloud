<template>
  <div class="app-container">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="总行资料" name="first">
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <!--          size="mini"-->
          <!--          @click="handleExport"-->
          <!--          v-hasPermi="['finance:bank:export']"-->
          <!--        >导出</el-button>-->
          <!--      </el-col>-->
      ...
      <el-tab-pane label="分行资料" name="second">
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="代码来源" prop="banknoSrc">
              <el-select v-model="form.banknoSrc" placeholder="请选择代码来源">
                <el-option
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="总行国别" prop="countryId">
              <el-select v-model="form.countryId" placeholder="请输入总行国别">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="银行型态" prop="bankType">
              <el-select v-model="form.bankType" placeholder="请输入银行型态">
                <el-option
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <div class="block">
              <span class="demonstration">新增日期</span>
              <el-date-picker
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <div class="block">
              <span class="demonstration">异动日期</span>
              <el-date-picker
...
import branch from "@/views/finance/aa/branch";
...
export default {
  ...
  methods: {
    ...
    // /** 导出按钮操作 */
    // handleExport() {
    //   this.download('finance/bank/export', {
    //     ...this.queryParams
