<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="branchList"
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="分行简称" prop="branchchnabbr">
              <el-input v-model="form.branchchnabbr" placeholder="请输入分行简称" />
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        branchchnabbr: [
          { required: true, message: "分行中文简称不能为空", trigger: "blur" },
          {max: 60 ,trigger: 'blur',message: "最大不超过60个字符"}
        ],
        branchchnname: [
          { required: true, message: "分行中文全名不能为空", trigger: "blur" },
  ...
  props: ['applyId','bankNo','bankchnName'],
  mounted() {
