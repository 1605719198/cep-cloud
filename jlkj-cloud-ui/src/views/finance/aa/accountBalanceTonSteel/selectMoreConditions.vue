  ...
  <el-dialog title="查询条件" :visible.sync="visible" width="800px"
    ...
    <el-form :model="queryParams" ref="queryForm" size="small"
      ...
      <el-row>
        ...
        <el-col   :span="24">
          <el-form-item label="报表" prop="reportType">
            <el-select v-model="queryParams.reportType"
                       filterable placeholder="请输入报表">
              <el-option
                v-for="dict in dict.type.account_balance_type"
                :key="dict.value"
                :label="dict.label"
                :value="dict.value"
        ...
        <el-col   :span="24" v-if="calTypeCodeIf">
...
export default {
  ...
  dicts: ['account_balance_type', 'account_level','aa_yes_no'],
  components: {
  ...
  data() {
    return {
      ...
      rulesQuery: {
        ...
        reportType: [
          {required: true, message: '请输入报表', trigger: 'blur'}
        ],
      },
      // 核算项目类别选单
      calTypeList: [],
