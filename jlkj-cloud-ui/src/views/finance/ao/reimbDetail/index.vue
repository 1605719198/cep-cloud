    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['finance:reimbDetail:add']"
        >新增细项</el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            v-hasPermi="['finance:reimbDetail:remove']"
          >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { listReimbDetail, getReimbDetail, delReimbDetail, addReimbDetail, updateReimbDetail,changeStatus } from "@/api/finance/ao/reimbDetail";
  ...
  methods: {
    ...
    getAccountCodeData(val) {
      if (this.tagSrc === 'drCodeClick') {
        this.form.drAcctCode = val[0].groupAcctCode
        this.form.drAcctName = val[0].groupAcctName
      }else if(this.tagSrc === 'crCodeClick') {
        this.form.crAcctCode = val[0].groupAcctCode
        this.form.crAcctName = val[0].groupAcctName
      }
    },
    ...
    handleUpdate(row) {
      ...
      getReimbDetail(id).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateReimbDetail(this.form).then(response => {
