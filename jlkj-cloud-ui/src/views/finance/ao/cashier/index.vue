<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="申请人" prop="cashierName">
        <el-input
          ...
          @keyup.enter.native="handleQuery"
        />
        <!--        <el-input v-model="queryParams.cashierName" placeholder="请输入申请人">
    ...
    <el-table v-loading="loading" :data="cashierList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="申请人" align="center" prop="cashierName" />
...
<script>
import { listCashier } from "@/api/finance/ao/cashier";
...
export default {
  ...
  data() {
    return {
      ...
      ids: [],
      // 子表选中数据
      checkedFinanceAoAccountCashier: [],
      // 非单个禁用
      single: true,
      // 非多个禁用
      multiple: true,
  ...
  methods: {
    ...
    reset() {
      ...
      this.financeAoAccountCashierList = [];
      this.resetForm("form");
    },
    /** 搜索按钮操作 */
    handleQuery() {
