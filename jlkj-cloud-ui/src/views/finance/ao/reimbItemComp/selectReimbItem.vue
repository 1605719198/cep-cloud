  ...
  <el-dialog title="选取集团报支类别" :visible.sync="visible" width="800px" top="5vh" append-to-body>
    <el-row>
      <el-table @row-click="clickRow" ref="table" :data="userList" @selection-change="handleSelectionChange" height="260px" >
        ...
        <el-table-column label="报支类别编码" prop="itemName" :show-overflow-tooltip="true" align="center"/>
      </el-table>
      <pagination
        v-show="total>0"
        :total="total"
...
<script>
import { listItemAndDetail }  from "@/api/finance/ao/reimbItem";
import { addBatchData }  from "@/api/finance/ao/reimbItemComp";
export default {
  props: ['companyId'],
  data() {
    return {
