<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="参数代码" prop="parameterKey">
        <el-input
    ...
    <el-table v-loading="loading" :data="paraList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="参数代码" align="center" prop="parameterKey" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="参数代码" prop="parameterKey">
          <el-input v-model="form.parameterKey" placeholder="请输入参数代码" class="input"/>
        </el-form-item>
        <el-form-item label="参数说明" prop="parameterDesc">
          <el-input v-model="form.parameterDesc" placeholder="请输入参数说明" class="input"/>
        </el-form-item>
        <el-form-item label="参数值" prop="parameterValue">
          <el-input v-model="form.parameterValue" placeholder="请输入参数值" class="input"/>
        </el-form-item>
      </el-form>
...
<script>
import {addPara, delPara, getPara, listPara, updatePara} from "@/api/finance/ap/para";
...
export default {
    ...
    return {
      ...
      rules: {
        ...
        parameterKey: [
          ...
          {max: 32 ,trigger: 'blur',message: "最大不超过32个字符"}
        ],
        parameterDesc: [
        ...
        parameterValue: [
          ...
          {max: 20 ,trigger: 'blur',message: "最大不超过20个字符"}
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除应付参数维护编号为"' + ids + '"的数据项？').then(function() {
        return delPara(ids);
      }).then(() => {
        this.getList();
