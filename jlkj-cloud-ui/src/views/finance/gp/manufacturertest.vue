            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="所在区码:" prop="mainAreaId">
                  ...
                  <el-select v-if="mainAreaIdIf" v-model="dataForm.mainAreaId" :disabled="mainAreaIdDisabled"
                             style="width: 100px"
                             placeholder="请选择所在区码">
                    <el-option
                ...
                <el-form-item prop="detailAreaId">
                  ...
                  <el-select v-if="mainAreaIdIf" v-model="dataForm.detailAreaId" clearable placeholder="请选择所在区码"
                             :disabled="mainAreaIdDisabled" filterable style="width: 100px">
                    <el-option v-for="dict in dict.type.gp_detail_areaid" :label="dict.value+'_'+dict.label"
                               :key="dict.value" :value="dict.value"></el-option>
                  </el-select>
              ...
              <el-col :span="12">
                <el-form-item label="是否集采:" prop="isCentralizedPurchase">
                  <el-select v-model="dataForm.isCentralizedPurchase" :disabled="currencyDisabled"
                             placeholder="请选择厂商简称"
                             style="width: 200px">
                    <el-option
              ...
              <el-col :span="12">
                <el-form-item label="资本额:" prop="capital">
                  <el-input maxlength="18" v-model="dataForm.capital" :disabled="currencyDisabled"
              ...
              <el-col :span="24">
                <el-form-item label="业务关系:" prop="relation">
                  <el-select multiple v-model="dataForm.relation" :disabled="currencyDisabled"
                             placeholder="请选择业务关系">
                    <el-option
...
import {
  queryRelations,
  getBase1,
  updateManufacturerBasics,
  addManufacturerBasics,
  selectGoodsByGroupId
} from "@/api/finance/gp/base1";
