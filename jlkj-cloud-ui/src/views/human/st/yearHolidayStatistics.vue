...
export default {
  ...
  methods: {
    ...
    /** 搜索按钮操作 */
    handleQuery() {
      if(this.queryParams.year===null||this.queryParams.year===''){
    ...
    /** 导出按钮操作 */
    handleExport() {
      window.open('http://10.32.157.51:9205/ureport/preview?_u=file:年休假统计表.ureport.xml&compId='+this.queryParams.compId+'&year='+this.queryParams.year, '_blank');
    }
  }
};
</script>
