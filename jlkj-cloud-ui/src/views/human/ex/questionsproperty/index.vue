...
<script>
import { listQuestionsproperty, getQuestionsproperty, delQuestionsproperty, addQuestionsproperty, updateQuestionsproperty, exportQuestionsproperty } from "@/api/human/ex/questionsproperty";
