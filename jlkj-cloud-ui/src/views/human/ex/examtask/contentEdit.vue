  ...
  methods: {
    ...
    onTimeChange() {
      if (this.startDate === undefined || this.startDate === null) {
        ...
        this.$modal.msgError('请先输入考试开始时间');
        return;
      }
      this.set_time();
    },
