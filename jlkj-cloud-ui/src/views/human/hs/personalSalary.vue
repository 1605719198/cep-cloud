...
<!--        <el-select v-model="queryParams.compId" placeholder="请选择公司ID" ref="selectComp">-->
<!--          <el-option-->
...
<!--import { listPersonalSalary, getPersonalSalary, delPersonalSalary, addPersonalSalary, updatePersonalSalary, getSalaryBank, getPayFormation } from "@/api/human/hs/personalSalary";-->
