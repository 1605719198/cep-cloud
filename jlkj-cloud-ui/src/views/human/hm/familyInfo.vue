<template>
  <div>
    <el-button v-hasPermi="['human:familyInfo:save']" type="primary" size="medium" plain @click="handleSave">保存</el-button>
    <el-button v-hasPermi="['human:familyInfo:remove']" type="danger" size="medium" plain :disabled="multiple" @click="handleDelete">删除</el-button>
