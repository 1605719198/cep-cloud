<template>
  <div>
    <el-button v-hasPermi="['human:professionalInfo:save']" type="primary" size="medium" plain @click="handleSave">保存</el-button>
    <el-button v-hasPermi="['human:professionalInfo:remove']" type="danger" size="medium" plain :disabled="multiple" @click="handleDelete">删除</el-button>
