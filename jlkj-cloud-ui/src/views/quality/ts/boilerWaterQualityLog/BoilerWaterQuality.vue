      ...
      <el-form>
        ...
        <table v-if="this.tableData.length > 0"
          ...
          <tr class="column">
            ...
            <td width="250px"
                v-for="(itemA,i) in this.averageList.slice(0,4)"
                :key="'a'+i">
              {{ itemA }}
            </td>
          </tr>
          <tr class="column">
            ...
            <td v-for="(itemB,i) in this.maxList.slice(0,4)"
                :key="'b'+i">
              {{ itemB }}
            </td>
          </tr>
          <tr class="column">
            ...
            <td v-for="(itemC,i) in this.minList.slice(0,4)"
                :key="'c'+i">
              {{ itemC }}
            </td>
          </tr>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { label: '磷酸根离子', prop: "磷酸根离子", sortable: true, minWidth: '80px' },
  ...
  created () {
    ...
    this.getDicts("quality_boiler_water_sample_type").then(response => {
      for (const responseElement of response.data) {
        if (responseElement.dictLabel==='能源水系统锅炉炉内水'){
