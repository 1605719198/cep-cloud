  ...
  data () {
    return {
      ...
      columns: [
        ...
        { label: '细度（%）', prop: "xd", sortable: true, minWidth: '80px' },
        { label: 'X（mm）', prop: "x", sortable: true, minWidth: '80px' },
        { label: 'Y（mm）', prop: "y", sortable: true, minWidth: '80px' },
        { label: 'G', prop: "g", sortable: true, minWidth: '80px' },
      ],
      tableData: [],
      averageList: [],
      maxList: [],
