      ...
      <el-form>
        ...
        <table v-if="this.tableData.length > 0"
          ...
          <tr class="column">
            ...
            <td width="200px"
                v-for="(itemA,i) in this.averageList.slice(6,10)"
                :key="'a'+i">
              {{ itemA }}
            </td>
          </tr>
          <tr class="column">
            ...
            <td v-for="(itemB,i) in this.maxList.slice(6,10)"
                :key="'b'+i">
              {{ itemB }}
            </td>
          </tr>
          <tr class="column">
            ...
            <td v-for="(itemC,i) in this.minList.slice(6,10)"
                :key="'c'+i">
              {{ itemC }}
            </td>
          </tr>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { label: '钠离子', prop: "钠离子", sortable: true, minWidth: '80px' }
      ],
      tableData: [],
      averageList: [],
      maxList: [],
