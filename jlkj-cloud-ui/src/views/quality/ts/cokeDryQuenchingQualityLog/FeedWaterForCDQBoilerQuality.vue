      ...
      <el-form>
        ...
        <table v-if="this.tableData.length > 0"
          ...
          <tr class="column">
            ...
            <td width="200px"
                v-for="(itemA,i) in this.averageList.slice(5,9)"
                :key="'a'+i">
              {{ itemA }}
            </td>
          </tr>
          <tr class="column">
            ...
            <td v-for="(itemB,i) in this.maxList.slice(5,9)"
                :key="'b'+i">
              {{ itemB }}
            </td>
          </tr>
          <tr class="column">
            ...
            <td v-for="(itemC,i) in this.minList.slice(5,9)"
                :key="'c'+i">
              {{ itemC }}
            </td>
          </tr>
...
export default {
  name: "BoilerFeedWaterQuality.vue",
  data () {
    return {
      page: {
        pageSize: 20,
