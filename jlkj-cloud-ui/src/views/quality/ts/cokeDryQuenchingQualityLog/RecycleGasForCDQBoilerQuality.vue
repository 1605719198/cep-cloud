      ...
      <el-form>
        ...
        <table v-if="this.tableData.length > 0"
          ...
          <tr class="column">
            ...
            <td width="206px"
                v-for="(itemA,i) in this.averageList.slice(0,3)"
                :key="'a'+i">
              {{ itemA }}
            </td>
          </tr>
          <tr class="column">
            ...
            <td v-for="(itemB,i) in this.maxList.slice(0,3)"
                :key="'b'+i">
              {{ itemB }}
            </td>
          </tr>
          <tr class="column">
            ...
            <td v-for="(itemC,i) in this.minList.slice(0,3)"
                :key="'c'+i">
              {{ itemC }}
            </td>
          </tr>
...
export default {
  name: "RecycleGasForCDQBoilerQuality",
  data () {
    return {
      page: {
        pageSize: 20,
      ...
      columns: [
        ...
        { label: '班次', prop: "shift", sortable: true, minWidth: '60px' },
        ...
        { label: '二氧化碳', prop: "二氧化碳", sortable: true, minWidth: '80px' },
        { label: '氧气', prop: "氧气", sortable: true, minWidth: '80px' },
        { label: '一氧化碳', prop: "一氧化碳", sortable: true, minWidth: '80px' }
      ],
      tableData: [],
      averageList: [],
      maxList: [],
