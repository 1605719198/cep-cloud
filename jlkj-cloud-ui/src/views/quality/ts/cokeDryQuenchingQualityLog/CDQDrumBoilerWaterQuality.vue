      ...
      <el-form>
        ...
        <table v-if="this.tableData.length > 0"
          ...
          <tr class="column">
            ...
            <td width="176px"
                v-for="(itemA,i) in this.averageList.slice(3,8)"
                :key="'a'+i">
              {{ itemA }}
            </td>
          </tr>
          <tr class="column">
            ...
            <td v-for="(itemB,i) in this.maxList.slice(3,8)"
                :key="'b'+i">
              {{ itemB }}
            </td>
          </tr>
          <tr class="column">
            ...
            <td v-for="(itemC,i) in this.minList.slice(3,8)"
                :key="'c'+i">
              {{ itemC }}
            </td>
          </tr>
...
<script>
import { queryCdqInfo } from "@/api/quality/ts/cdqQualityLog";

export default {
  name: "BoilerWaterQuality",
  data () {
    return {
      page: {
        pageSize: 20,
      ...
      columns: [
        ...
        { label: '来样时间', prop: "receiveTime", sortable: true, minWidth: '70px' },
        { label: '报出时间', prop: "sendTime", sortable: true, minWidth: '70px' },
        { label: '氯离子', prop: "氯离子", sortable: true, minWidth: '80px' },
        { label: '正磷酸盐', prop: "正磷酸盐", sortable: true, minWidth: '80px' },
        { label: 'PH', prop: "ph", sortable: true, minWidth: '80px' },
        { label: '电导率', prop: "电导率", sortable: true, minWidth: '80px' },
        { label: '二氧化硅', prop: "二氧化硅", sortable: true, minWidth: '80px' }
      ],
      tableData: [],
      averageList: [],
      maxList: [],
