    ...
    <el-col :span="24"
      ...
      <div class="energy_main">
        <div class="avue-crud el-card__body"
          ...
          <div class="avue-crud__search"
            ...
            <el-form>
              <el-row :gutter="20">
                ...
                <el-col :span="3">
                  <el-form-item label="">
                    <el-input v-model="query.sampleDesc"
                              placeholder="样品类别说明" />
                  </el-form-item>
                </el-col>
                <el-col :span="14">
                ...
                <el-col :span="4">
                  <div class="el-form-item__content"
                       style="float: right">
                    <el-button v-hasPermi="['sampleBasicData_add']"
                               type="primary"
                               size="medium"
                               icon="el-icon-plus"
              ...
              <el-table height="67.1vh"
                ...
                <el-table-column fixed="right"
                  ...
                  <template slot-scope="scope">
                    <el-button v-hasPermi="['sampleBasicData_update']"
                               size="mini"
                               plain
                               icon="el-icon-edit"
                               type="primary"
                    ...
                    <el-button v-hasPermi="['sampleBasicData_delete']"
                               size="mini"
                               plain
                               icon="el-icon-delete"
                               type="danger"
                    ...
                    <el-button v-hasPermi="['sampleBasicData_query']"
                               size="mini"
                               plain
                               icon="el-icon-search"
                               type="primary"
          ...
          <div v-if="addBox">
            <el-dialog :title="(editBox?'编辑':'新建')+'样品基本资料'"
                       :visible.sync="addBox"
                       width="1200px"
              ...
              <sampleDataAdd :dataEdit="dataEdit"
                             @submitAdd="submitAdd"
                             @close="addBox=false" />
            </el-dialog>
          </div>
          ...
          <div v-if="detailBox">
            <el-dialog :title="'样品基本资料详情'"
                       ...
                       :close-on-click-modal="false"
                       style="margin-top: -10vh">
              <sampleDataAdd :detailBox="detailBox"
                             :dataEdit="dataEdit"
                             @submitAdd="submitAdd"
...
import sampleDataAdd from "./SampleDataAdd";
import { addInfo, delInfo, queryInfo, queryTsSampleInfo, updateInfo } from "@/api/quality/ts/sampleData";
export default {
  components: {
    sampleDataAdd
  },
  ...
  data () {
    return {
      ...
      columns: [
        { label: '样品类别', prop: "sampleClass", sortable: true, minWidth: '100px' },
        { label: '样品类别说明', prop: "sampleDesc", sortable: true, minWidth: '120px' },
  ...
  methods: {
    ...
    handleEdit (index, row) {
      queryTsSampleInfo(row.sampleClass).then(response => {
        row.sendValues = response.data.data.databList
    ...
    handleDelete (index, row) {
      this.$confirm('此操作将删除该条记录, 是否继续?', '提示', {
        ...
        //调用删除的方法
        delInfo(row.sampleClass).then(response => {
          this.getList();
          this.$message({
            type: 'success',
            message: response.data.msg
