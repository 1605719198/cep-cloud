  ...
  <div class="app-container">
    <el-form :inline="true" label-width="68px" v-show="showSearch">
      <el-form-item label="产线代码">
        <el-select v-model="queryParams.millIdCodeStart"
                   clearable
        ...
        ~
        <el-select v-model="queryParams.millIdCodeEnd"
                   clearable
                   placeholder="请选择工厂产线代码"
                   style="width: 215px!important;">
      ...
      <el-form-item>
        <el-button v-hasPermi="['mill:cost:query']"
                   type="primary"
                   size="mini"
                   icon="el-icon-search"
                   @click="handleQuery"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button v-hasPermi="['mill:cost:add']"
                   type="primary"
                   plain
                   size="mini"
                   icon="el-icon-plus"
      ...
      <el-col :span="1.5">
        <el-button v-hasPermi="['mill:cost:delete']"
                   type="danger"
                   size="mini"
                   icon="el-icon-delete"
