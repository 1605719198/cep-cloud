  ...
  <el-row class="row" type="flex" justify="space-around" :gutter="10">
    <el-col :span="16" style="height: 100%">
      <div class="ranking-board-title1" style="justify-content: space-between;">
        <div class="ranking-board-title">动力气体消耗数据统计分析</div>
      ...
      <div id="place5" style="position: relative; height: 40vh;">
        <div id="chart5" style="position:absolute; height: 35vh; width: 55vw;" />
      </div>
    </el-col>

    <el-col :span="8">
      <div class="ranking-board-title">动力气体消耗数据统计分析</div>
      <div id="place6" style="position: relative; height: 35vh;">
    ...
    engyBottom () {
      ...
      getEngyTopAnalys(this.qry1).then(res => {
        ...
        data.forEach(item => {
          ...
          if(item.energy_code_name=='压缩空气'){this.planData.push(item.qty)}
