  ...
  <el-row class="row" type="flex" justify="space-around" :gutter="10">
    <el-col :span="16" style="height: 100%">
      <div class="ranking-board-title1" style="justify-content: space-between;">
        <div class="ranking-board-title">耗水数据统计分析</div>
      ...
      <div id="place3" style="position: relative; height: 40vh;">
        <div id="chart3" style="position:absolute; height: 35vh; width: 55vw;" />
      </div>
    </el-col>

    <el-col :span="8">
      <div class="ranking-board-title">耗水数据统计分析</div>
      <div id="place4" style="position: relative; height: 35vh;">
    ...
    engyBottom () {
      ...
      getEngyTopAnalys(this.qry1).then(res => {
        ...
        data.forEach(item => {
          ...
          if(item.energy_code_name=='生产消防水'){this.planData.push(item.qty)}
