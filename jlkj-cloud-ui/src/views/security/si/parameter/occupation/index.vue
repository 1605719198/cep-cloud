        ...
        <el-table height="71vh"
          ...
          <el-table-column fixed="right"
            ...
            <template slot-scope="scope">
              <el-button v-hasPermi="['worktype_update']"
                         size="mini"
                         plain
                         icon="el-icon-edit"
                         type="text"
...
<script>
import { worktypeList } from "@/api/security/si/parameter/occupation";
...
export default {
  ...
  methods: {
    ...
    onLoad () {
      ...
      worktypeList(this.page, this.query).then(res => {
    ...
    //   }).then(() => {
    //     worktypeDelete({ id: row.id }).then(res => {
    //       this.onLoad();
