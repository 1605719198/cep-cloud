      ...
      <div>
        <el-table height="71vh"
          ...
          <el-table-column label="序号"
                           ...
                           width="55"
                           align="center" />
          <el-table-column label="知识类别名称"
                           sortable
                           minWidth="150"
                           align="left"
                           prop="knowledge_category_name" />
          <el-table-column label="上级知识类别名称"
                           sortable
                           minWidth="150"
                           align="left"
                           prop="parent_knowledge_category_name" />
          ...
          <el-table-column fixed="right"
            ...
            <template slot-scope="scope">
              <el-button v-hasPermi="['knowledgecategory_update']"
                         size="mini"
                         plain
                         icon="el-icon-edit"
                         type="text"
              ...
              <el-button v-hasPermi="['knowledgecategory_delete']"
                         size="mini"
                         plain
                         icon="el-icon-delete"
                         type="text"
...
<script>
import { knowledgecategoryList, knowledgecategoryDelete } from "@/api/security/si/parameter/knowledgeCategory";
...
export default {
  ...
  methods: {
    ...
    onLoad () {
      ...
      knowledgecategoryList(this.page, this.query).then(res => {
    ...
    handleDelete (index, row) {
      this.$confirm('是否确认删除数据项?', '警告', {
        ...
        knowledgecategoryDelete({ id: row.id }).then(res => {
          this.onLoad();
