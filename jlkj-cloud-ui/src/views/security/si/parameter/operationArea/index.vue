        ...
        <el-row>
          <el-col :span="20">
            ...
            <el-form :model="query"
              ...
              <!-- 操作按钮 -->
              <el-form-item>
                <el-button v-hasPermi="['area_list']"
                           @click="handleQuery"
                           type="primary"
                           icon="el-icon-search"
          ...
          <el-col :span="4">
            <div style="text-align: right;margin:0 10px 26px 0;">
              <el-button v-hasPermi="['area_insert']"
                         type="primary"
                         size="mini"
                         icon="el-icon-plus"
                           style="margin: 5px 0;"
      ...
      <div>
        <el-table height="71vh"
          ...
          <el-table-column label="序号"
                           ...
                           width="55"
                           align="center" />
          <el-table-column label="作业区域名称"
                           sortable
                           minWidth="150"
                           align="left"
                           prop="safe_area_name" />
          <el-table-column label="经度坐标"
                           sortable
                           minWidth="150"
                           align="left"
                           prop="lng" />
          <el-table-column label="纬度坐标"
                           sortable
                           minWidth="150"
                           align="left"
                           prop="lat" />
          ...
          <el-table-column fixed="right"
            ...
            <template slot-scope="scope">
              <el-button v-hasPermi="['area_update']"
                         size="mini"
                         plain
                         icon="el-icon-edit"
                         type="text"
              ...
              <el-button v-hasPermi="['area_delete']"
                         size="mini"
                         plain
                         icon="el-icon-delete"
                         type="text"
...
<script>
import { arealist, areaDelete } from "@/api/security/si/parameter/operationArea";
...
export default {
  ...
  methods: {
    ...
    onLoad () {
      ...
      arealist(this.page, this.query).then(res => {
