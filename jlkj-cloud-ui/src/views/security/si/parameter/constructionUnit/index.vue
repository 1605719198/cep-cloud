        ...
        <el-row>
          <el-col :span="20">
            ...
            <el-form :model="query"
                     ref="query"
                     :inline="true">
              <el-form-item label="单位名称" prop="construction_unit_name">
                <el-input v-model="query.construction_unit_name"
                          placeholder="单位名称"></el-input>
              </el-form-item>
              <!-- 操作按钮 -->
              <el-form-item>
                <el-button v-hasPermi="['constructionunit_list']"
                           @click="handleQuery"
                           type="primary"
                           icon="el-icon-search"
        ...
        <el-table height="71vh"
          ...
          <el-table-column fixed="right"
            ...
            <template slot-scope="scope">
              <el-button v-hasPermi="['constructionunit_update']"
                         size="mini"
                         plain
                         icon="el-icon-edit"
                         type="text"
              ...
              <el-button v-hasPermi="['constructionunit_delete']"
                         size="mini"
                         plain
                         icon="el-icon-delete"
                         type="text"
...
<script>
import { constructionunitList, constructionunitDelete } from "@/api/security/si/parameter/constructionUnit";
...
export default {
  ...
  methods: {
    ...
    onLoad () {
      ...
      constructionunitList(this.page, this.query).then(res => {
    ...
    handleDelete (index, row) {
      this.$confirm('是否确认删除数据项?', '警告', {
        ...
        constructionunitDelete({ id: row.id }).then(res => {
          this.onLoad();
