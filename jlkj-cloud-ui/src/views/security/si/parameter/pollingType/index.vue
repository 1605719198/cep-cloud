        ...
        <el-row>
          ...
          <el-col :span="4">
            <div style="text-align: right;margin:0 10px 26px 0;">
              <el-button v-hasPermi="['checktype_insert']"
                         type="primary"
                         size="mini"
                         icon="el-icon-plus"
                           style="margin: 5px 0;"
        ...
        <el-table height="71vh"
          ...
          <el-table-column fixed="right"
            ...
            <template slot-scope="scope">
              <el-button v-hasPermi="['checktype_update']"
                         size="mini"
                         plain
                         icon="el-icon-edit"
                         type="text"
              ...
              <el-button v-hasPermi="['checktype_delete']"
                         size="mini"
                         plain
                         icon="el-icon-delete"
                         type="text"
...
<script>
import { checktypelist, checktypeDelete } from "@/api/security/si/parameter/pollingType";
...
export default {
  ...
  methods: {
    ...
    onLoad () {
      ...
      checktypelist(this.page, this.query).then(res => {
    ...
    handleDelete (index, row) {
      this.$confirm('是否确认删除数据项?', '警告', {
        ...
        checktypeDelete({ id: row.id }).then(res => {
          this.onLoad();
