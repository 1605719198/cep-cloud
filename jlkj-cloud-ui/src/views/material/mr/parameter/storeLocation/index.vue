<template>
  <div class="avue-crud el-card__body" style="width: 98%;border: 0">
    <div class="avue-crud__search search" style="border: 0">
      <el-row>
        <el-form :model="query" ref="query" :inline="true">
          <el-form-item prop="siloId" style="margin-right:20px;" label="料仓">
            <el-select :popper-append-to-body="false" v-model="query.siloId" clearable placeholder="选择料仓">
          ...
          <el-form-item>
            <el-button v-hasPermi="['listStorageSpaces']"
                       @click="handleQuery" type="primary" icon="el-icon-search" size="mini">搜 索
            </el-button>
      ...
      <el-row class="mb5">
        <el-button v-hasPermi="['saveStorageSpaces']"
                   type="primary" size="mini" plain icon="el-icon-plus" @click="handleAdd('add')">新增
        </el-button>
      </el-row>
    </div>
    <div>
      <el-table height="69vh"
        ...
        <el-table-column label="料仓名称" sortable width="150" align="left" prop="silo_name"/>
        <el-table-column label="煤排" sortable width="100" align="left" prop="coal_sort"/>
        <el-table-column label="储位名称" sortable minWidth="150" align="left" prop="materials_small_name"/>
        <el-table-column label="创建人" sortable width="120" align="left" prop="create_user_name"/>
        <el-table-column label="创建时间" sortable width="150" align="left" prop="create_time"/>
        <el-table-column label="修改人" sortable width="120" align="left" prop="modify_user_name"/>
        <el-table-column label="修改时间" sortable width="150" align="left" prop="modify_time"/>
      ...
      <div style="margin-top: 10px;float: right;padding: 25px 0px 20px 20px;" class="avue-crud__pagination">
