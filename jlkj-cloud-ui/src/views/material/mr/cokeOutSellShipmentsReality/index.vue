...
<script>
import { listMaterialsCokeSaleWriteOffReal } from "@/api/material/mr/MaterialsCokeSaleWriteOffReal";
...
export default {
  ...
  methods: {
    ...
    onLoad() {
      ...
      listMaterialsCokeSaleWriteOffReal(this.page, this.query).then(res => {
