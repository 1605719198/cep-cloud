<template>
  <div>
    <el-table height="70vh" border :header-cell-style="{ background: '#f5f7fa', color: '#606266' }" size="small"
      ...
      <el-table-column label="小煤种" minWidth="150" align="left" prop="materials_small_name"/>
      <!--      <el-table-column label="物资品名  " minWidth="150" align="left" prop="material_name"/>-->
      <el-table-column label="车牌号码" minWidth="150" align="left" prop="vehicle_number"/>
      <el-table-column label="供货单位" minWidth="150" align="left" prop="supplier_name"/>
      <el-table-column label="卸车时间" sortable minWidth="150" align="left" prop="unloading_time"/>
      <el-table-column label="重量(t)" sortable minWidth="150" align="left" prop="material_weight">
...
export default {
    ...
    data() {
      return {
        ...
        table: {border: true},
        query: {categoryId: '', materialsId: '', materials_small_code: ''},
        tableData: [],
      }
    },
    created() {
