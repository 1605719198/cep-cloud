...
import render from '@/utilsflow/generator/render'
import FormDrawer from './FormDrawer'
import JsonDrawer from './JsonDrawer'
import RightPanel from './RightPanel'
import { inputComponents, selectComponents, layoutComponents, formConf } from '@/utilsflow/generator/config'
import { beautifierConf, titleCase, deepClone } from '@/utilsflow/index'
import { makeUpHtml, vueTemplate, vueScript, cssStyle } from '@/utilsflow/generator/html'
import { makeUpJs } from '@/utilsflow/generator/js'
import { makeUpCss } from '@/utilsflow/generator/css'
import drawingDefault from '@/utilsflow/generator/drawingDefault'
import logo from '@/assets/logo/logo.png'
import CodeTypeDialog from './CodeTypeDialog'
import DraggableItem from './DraggableItem'
import { getDrawingList, saveDrawingList, getIdGlobal, saveIdGlobal, getFormConf } from '@/utilsflow/db'
import loadBeautifier from '@/utilsflow/loadBeautifier'
